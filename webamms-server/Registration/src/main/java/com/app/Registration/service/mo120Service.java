...
import com.app.Registration.repository.mo120Repository;

@Service
@Component
public class mo120Service implements Iservice {
	@Autowired
	private mo120Repository repo;

	public List<com.app.Registration.model.mo120> fetchProductList() {
		return repo.findAll();
	}

	public mo120 saveservicetoDB(mo120 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo120> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo120> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo120> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo120> findPaginatedmo120(int pageNo, int perpage) {
		...
		Page<mo120> pagedresult = repo.findAll(pageable);
	...
	public List<mo120> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo120> pagedresult1 = (List<mo120>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo120> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo120> pagedresult1 = (List<mo120>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
