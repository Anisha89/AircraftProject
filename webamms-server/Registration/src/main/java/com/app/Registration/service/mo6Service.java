...
import com.app.Registration.repository.mo6Repository;

@Service
@Component
public class mo6Service implements Iservice {
	@Autowired
	private mo6Repository repo;

	public List<com.app.Registration.model.mo6> fetchProductList() {
		return repo.findAll();
	}

	public mo6 saveservicetoDB(mo6 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo6> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo6> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo6> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo6> findPaginatedmo6(int pageNo, int perpage) {
		...
		Page<mo6> pagedresult = repo.findAll(pageable);
	...
	public List<mo6> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo6> pagedresult1 = (List<mo6>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo6> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo6> pagedresult1 = (List<mo6>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
