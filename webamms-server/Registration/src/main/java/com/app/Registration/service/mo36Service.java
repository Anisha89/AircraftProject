...
import com.app.Registration.repository.mo36Repository;

@Service
@Component
public class mo36Service implements Iservice {
	@Autowired
	private mo36Repository repo;
	
	public List<com.app.Registration.model.mo36> fetchProductList() {
		return repo.findAll();
	}

	public mo36 saveservicetoDB(mo36 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo36> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo36> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo36> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo36> findPaginatedmo36(int pageNo, int perpage) {
		...
		Page<mo36> pagedresult = repo.findAll(pageable);
	...
	public List<mo36> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo36> pagedresult1 = (List<mo36>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo36> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo36> pagedresult1 = (List<mo36>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
