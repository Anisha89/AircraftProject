...
import com.app.Registration.repository.mo90Repository;

@Service
@Component
public class mo90Service implements Iservice {
	@Autowired
	private mo90Repository repo;

	public List<com.app.Registration.model.mo90> fetchProductList() {
		return repo.findAll();
	}

	public mo90 saveservicetoDB(mo90 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo90> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo90> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo90> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo90> findPaginatedmo90(int pageNo, int perpage) {
		...
		Page<mo90> pagedresult = repo.findAll(pageable);
	...
	public List<mo90> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo90> pagedresult1 = (List<mo90>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo90> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo90> pagedresult1 = (List<mo90>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
