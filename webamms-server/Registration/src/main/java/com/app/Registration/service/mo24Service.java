...
import com.app.Registration.repository.mo24Repository;

@Service
@Component
public class mo24Service implements Iservice {
	@Autowired
	private mo24Repository repo;

	public List<com.app.Registration.model.mo24> fetchProductList() {
		return repo.findAll();
	}

	public mo24 saveservicetoDB(mo24 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo24> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo24> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo24> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo24> findPaginatedmo24(int pageNo, int perpage) {
		...
		Page<mo24> pagedresult = repo.findAll(pageable);
	...
	public List<mo24> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo24> pagedresult1 = (List<mo24>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo24> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo24> pagedresult1 = (List<mo24>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
