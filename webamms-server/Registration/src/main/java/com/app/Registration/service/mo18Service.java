...
import com.app.Registration.repository.mo18Repository;

@Service
@Component
public class mo18Service implements Iservice {
	@Autowired
	private mo18Repository repo;

	public List<com.app.Registration.model.mo18> fetchProductList() {
		return repo.findAll();
	}

	public mo18 saveservicetoDB(mo18 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo18> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo18> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo18> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo18> findPaginatedmo18(int pageNo, int perpage) {
		...
		Page<mo18> pagedresult = repo.findAll(pageable);
	...
	public List<mo18> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo18> pagedresult1 = (List<mo18>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo18> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo18> pagedresult1 = (List<mo18>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
