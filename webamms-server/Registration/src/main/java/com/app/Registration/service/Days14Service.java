...
import com.app.Registration.repository.Days14Repository;

@Service
@Component
public class Days14Service implements Iservice {
	@Autowired
	private Days14Repository repo;

	public days14 savedays14(days14 service) {
		return repo.save(service);
	}

	public List<com.app.Registration.model.days14> fetchProductList() {
		return repo.findAll();
	}

	public java.util.Optional<days14> fetchdays14ById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<days14> deletedays14ByIdtest(int id) throws Exception {
		java.util.Optional<days14> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<days14> findPaginateddays14(int pageNo, int perpage) {
		...
		Page<days14> pagedresult = repo.findAll(pageable);
	...
	public List<days14> findBydays14number(String seqno, int pageable, int perpage) {
		List<days14> pagedresult1 = (List<days14>) repo.findBydays14(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<days14> findBydays14smrdno(String seqno, int pageable, int perpage) {
		List<days14> pagedresult1 = (List<days14>) repo.findBydays14smrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public int countdays14(String seqno) {
		return repo.countdays14(seqno);
	}
