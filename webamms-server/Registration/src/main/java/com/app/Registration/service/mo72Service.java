...
import com.app.Registration.repository.mo72Repository;

@Service
@Component
public class mo72Service implements Iservice {
	@Autowired
	private mo72Repository repo;

	public List<com.app.Registration.model.mo72> fetchProductList() {
		return repo.findAll();
	}

	public mo72 saveservicetoDB(mo72 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo72> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo72> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo72> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo72> findPaginatedmo72(int pageNo, int perpage) {
		...
		Page<mo72> pagedresult = repo.findAll(pageable);
	...
	public List<mo72> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo72> pagedresult1 = (List<mo72>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo72> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo72> pagedresult1 = (List<mo72>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
