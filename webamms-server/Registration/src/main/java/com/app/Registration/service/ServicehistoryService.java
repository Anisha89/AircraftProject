...
@Service
@Component
public class ServicehistoryService implements Iservice {
	@Autowired
	...
	public Servicehistory saveServicehistorytoDB(Servicehistory service) {
		return repo.save(service);
	}

	public Optional<Servicehistory> fetchServicehistoryById(int id) {
	...
	public List<Servicehistory> findPaginatedservicehistory(int pageNo, int perpage) {
		...
		Page<Servicehistory> pagedresult = repo.findAll(pageable);
	...
	public int getCompletedCount() {
		return repo.getCompletedCount();
	}

	public int getNotStartedCount() {
		return repo.getNotStartedCount();
	}

	public int getProgressCount() {
		return repo.getProgressCount();
	}

	public List<Servicehistory> findbyaircraft1(String aircraft) {
		List<Servicehistory> pageresult3 = (List<Servicehistory>) repo.findbyaircraft1(aircraft);
		return pageresult3;
	}

	public List<Servicehistory> findbyservice(String service) {
		List<Servicehistory> pageresult3 = (List<Servicehistory>) repo.findbyservice(service);
		return pageresult3;
	}
