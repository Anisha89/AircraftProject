...
import com.app.Registration.repository.mo1Repository;

@Service
@Component
public class mo1Service implements Iservice {
	@Autowired
	private mo1Repository repo;
	
	public List<com.app.Registration.model.mo1> fetchProductList() {
		return repo.findAll();
	}

	public mo1 saveservicetoDB(mo1 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo1> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo1> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo1> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo1> findPaginatedmo1(int pageNo, int perpage) {
		...
		Page<mo1> pagedresult = repo.findAll(pageable);
	...
	public List<mo1> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo1> pagedresult1 = (List<mo1>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo1> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo1> pagedresult1 = (List<mo1>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
