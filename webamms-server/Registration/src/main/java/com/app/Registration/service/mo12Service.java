...
import com.app.Registration.repository.mo12Repository;

@Service
@Component
public class mo12Service implements Iservice {
	@Autowired
	private mo12Repository repo;

	public List<com.app.Registration.model.mo12> fetchProductList() {
		return repo.findAll();
	}

	public mo12 saveservicetoDB(mo12 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo12> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo12> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo12> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo12> findPaginatedmo12(int pageNo, int perpage) {
		...
		Page<mo12> pagedresult = repo.findAll(pageable);
	...
	public List<mo12> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo12> pagedresult1 = (List<mo12>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo12> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo12> pagedresult1 = (List<mo12>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
