...
import com.app.Registration.repository.mo3Repository;

@Service
@Component
public class mo3Service implements Iservice {
	@Autowired
	private mo3Repository repo;

	public List<com.app.Registration.model.mo3> fetchProductList() {
		return repo.findAll();
	}

	public mo3 saveservicetoDB(mo3 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo3> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo3> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo3> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo3> findPaginatedmo3(int pageNo, int perpage) {
		...
		Page<mo3> pagedresult = repo.findAll(pageable);
	...
	public List<mo3> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo3> pagedresult1 = (List<mo3>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo3> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo3> pagedresult1 = (List<mo3>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
