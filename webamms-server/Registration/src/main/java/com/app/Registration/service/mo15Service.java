...
import com.app.Registration.repository.mo15Repository;

@Service
@Component
public class mo15Service implements Iservice {
	@Autowired
	private mo15Repository repo;

	public List<com.app.Registration.model.mo15> fetchProductList() {
		return repo.findAll();
	}

	public mo15 saveservicetoDB(mo15 service) {
		return repo.save(service);
	}

	public java.util.Optional<mo15> fetchServiceById(int id) {
		return repo.findById(id);
	}

	public java.util.Optional<mo15> deleteserviceByIdtest(int id) throws Exception {
		java.util.Optional<mo15> u = this.repo.findById(id);
		if (u.isPresent())
	...
	public List<mo15> findPaginatedmo15(int pageNo, int perpage) {
		...
		Page<mo15> pagedresult = repo.findAll(pageable);
	...
	public List<mo15> findByservicenumber(String seqno, int pageable, int perpage) {
		List<mo15> pagedresult1 = (List<mo15>) repo.findByservice1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}

	public List<mo15> findByservicesmrdno(String seqno, int pageable, int perpage) {
		List<mo15> pagedresult1 = (List<mo15>) repo.findByservicesmrdno1(seqno, PageRequest.of(pageable, perpage));
		return pagedresult1;
	}
