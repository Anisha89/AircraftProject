...
import { Mo120,Gse,Tools,Spare,Consumable } from '../../mo120/mo120.model';
import { Mo120Service } from '../../mo120/mo120.service';
...
@Component({
  ...
  templateUrl: './editmo120.component.html',
  styleUrls: ['./editmo120.component.css']
})
export class Editmo120Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,
      private tservice:ToolsserviceService,
       private _activatedroute:ActivatedRoute,
       private _service :Mo120Service,
       private _gseservice:GseserviceService,
       private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo120(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo120=data;
          console.log("The gse s are="+this.mo120.gsenos);
     console.log(this.mo120);
       //   console.log("The spares  are="+this.mo120.sparenos);
           this.nam2=this.mo120.gsenos;
            this.name=this.mo120.gsenos;

             this.nam3=this.mo120.sparenos;
            this.namesp=this.mo120.sparenos;

            this.nam4=this.mo120.toolsnos;
            this.nametl=this.mo120.toolsnos;

            this.nam5=this.mo120.consumablenos;
            this.namecl=this.mo120.consumablenos;
            ...
            if (this.mo120.gsenos != null)
            {
          
            }
            if (this.mo120.sparenos!=null)
            {
            }
            if (this.mo120.toolsnos!=null)
            {
            }
            if (this.mo120.consumablenos!=null)
            {
            }
         if (this.mo120.gsenos==null)
         {
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo120(this.mo120).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/structure/mo120']);
         this.toastr.showInfo('Mo120 service updation success', 'Mo120 update');
       },
       error=>  this.toastr.showError(error,'Mo120 update')
