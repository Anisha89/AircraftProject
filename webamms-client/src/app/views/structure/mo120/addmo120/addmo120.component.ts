...
import { Mo120,Gse,Tools,Spare,Consumable } from '../mo120.model';
...
@Component({
  ...
  templateUrl: './addmo120.component.html',
  styleUrls: ['./addmo120.component.css']
})

export class Addmo120Component implements OnInit {
  mo120 =new Mo120();
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo120Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient ,private toastr:NotificationService) { }
...
console.log(this.mo120.gsenos);
  this._service.addUsertoRemotemo120(this.mo120).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess('Mo120 service added successfully', "Mo120 service");
