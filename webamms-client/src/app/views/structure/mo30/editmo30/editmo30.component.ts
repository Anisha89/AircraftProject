...
import { Mo30,Gse,Tools,Spare,Consumable } from '../../mo30/mo30.model';
import { Mo30Service } from '../../mo30/mo30.service';
...
@Component({
  ...
  templateUrl: './editmo30.component.html',
  styleUrls: ['./editmo30.component.css']
})
export class Editmo30Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,
      private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,
      private _service :Mo30Service,private _gseservice:GseserviceService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo30(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo30=data;
          console.log("The gse s are="+this.mo30.gsenos);
     console.log(this.mo30);
       //   console.log("The spares  are="+this.mo30.sparenos);
           this.nam2=this.mo30.gsenos;
            this.name=this.mo30.gsenos;

             this.nam3=this.mo30.sparenos;
            this.namesp=this.mo30.sparenos;

            this.nam4=this.mo30.toolsnos;
            this.nametl=this.mo30.toolsnos;

            this.nam5=this.mo30.consumablenos;
            this.namecl=this.mo30.consumablenos;
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo30(this.mo30).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/structure/mo30']);
         this.toastr.showInfo('Mo30 service updation success', 'Mo30 update');
       },
       error=>  this.toastr.showError(error,'Mo30 update')
