...
import { Mo30,Gse,Tools,Consumable,Spare } from '../mo30.model';
...
@Component({
  ...
  templateUrl: './addmo30.component.html',
  styleUrls: ['./addmo30.component.css']
})

export class Addmo30Component implements OnInit {
  mo30 =new Mo30();
...
copystrcl:any;
  ...
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,
    private toolsservice:ToolsserviceService, private _service :Mo30Service,
    private _gseservice:GseserviceService,private _spareservice:SpareserviceService,
    private _http:HttpClient,private toastr:NotificationService) { }
...
console.log(this.mo30.gsenos);
  this._service.addUsertoRemotemo30(this.mo30).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess('Mo30 service added successfully', "Mo30 service");
