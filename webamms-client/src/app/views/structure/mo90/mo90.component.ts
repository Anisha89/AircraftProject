...
import { Mo90Service } from './mo90.service';
...
@Component({
  selector: 'app-mo90',
  templateUrl: './mo90.component.html',
  providers: [
    { provide: CarouselConfig, useValue: { interval: 1500, noPause: false } },
  ],
 
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./mo90.component.css']
})

export class Mo90Component implements OnInit,OnDestroy {
  acitvities=[];
  start:any=1;
  datagse:any;
  dataspare:any;
 ...
 datapage:any;
  ...
  ngOnInit(): void {
    ...
    itemsPerPage: this.perpage,
     ...
     this._service.countrecordmo90().subscribe(
      mydata=>{console.log(mydata);
       ...
       this.m1=this.rec1;
        ...
        console.log("The perpage is "+this.perpage);
         ...
         this._service.getdatamo90(0,this.perpage).subscribe(
          (data)=>{console.log(data);
            this.data=data;
            this.mo90=data;
          this.totalItems=this.rec1;
          let activities=this.mo90;
           }/*for first mo90*/
      )/* for first getdata*/
...
handlePageChange(event:any) {
  this.x= event.page;
   ...
   if (this.mode=='searching')
   {
     ...
     this._service.counteruserecordmo90(this.searchname).subscribe(
   ...
   this._service.fetchUserBymo90(this.x-1,parseInt(this.perpage),this.searchname).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
     this.mo90=datasear;
     console.log("to test spare"+this.mo90);
     });
   ...
   {
   this._service.getdatamo90(this.x-1,this.perpage).subscribe(
     (data)=>{console.log(data);
       this.data=data;
 ...
 /*--------------------------------*/
   ...
   {
  this._service.fetchUserBymo90(this.m2,parseInt(this.perpage),name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
 ...
 {
   this._service.fetchUserBymo90(this.m2,this.perpage,name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
       this.rec1=this.searchpages;
...
gotodeleteuser(id: number)
  {
    this.mode="deleting";
     ...
     this._service.deleteUserByIdFromRemotemo90(id).subscribe (
       data => {
       ...
       // alert(this.x+this.perpageflag);
        if (this.perpageflag=="true")
        {
          this._service.getdatamo90(this.x-1,parseInt(this.perpage)).subscribe(
            (data)=>{console.log(data);
              this.data=data;
        ...
        {
          this._service.getdatamo90(this.x,3).subscribe(
            (data)=>{console.log(data);
              this.data=data;
            //  this.totalItems=String(100);
            })
        ...
        this.toastr.showWarning("Deletion success", 'Mo90 service');
      },
      error=>{
        this.msg1=error;
         console.log(this.msg1);
         this.toastr.showError(error,'Mo90 service')
      }
    ) 
