...
import { Mo90,Gse,Tools,Spare,Consumable } from '../mo90.model';
...
@Component({
  selector: 'app-addm90',
  templateUrl: './addmo90.component.html',
  styleUrls: ['./addmo90.component.css']
})

export class Addmo90Component implements OnInit {
  mo90 =new Mo90();
...
console.log(this.mo90.gsenos);
  this._service.addUsertoRemotemo90(this.mo90).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess('Mo90 service added successfully', "Mo90 service");
