...
import { Mo90,Gse,Tools,Spare,Consumable } from '../../mo90/mo90.model';
import { Mo90Service } from '../../mo90/mo90.service';
...
@Component({
  ...
  templateUrl: './editmo90.component.html',
  styleUrls: ['./editmo90.component.css']
})
export class Editmo90Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,
      private cservice:ConsumableserviceService,
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo90(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo90=data;
          console.log("The gse s are="+this.mo90.gsenos);
     console.log(this.mo90);
       //   console.log("The spares  are="+this.mo90.sparenos);
           this.nam2=this.mo90.gsenos;
            this.name=this.mo90.gsenos;

             this.nam3=this.mo90.sparenos;
            this.namesp=this.mo90.sparenos;

            this.nam4=this.mo90.toolsnos;
            this.nametl=this.mo90.toolsnos;

            this.nam5=this.mo90.consumablenos;
            this.namecl=this.mo90.consumablenos;
            ...
            if (this.mo90.gsenos != null)
            {
          
            }
            if (this.mo90.sparenos!=null)
            {
            }
            if (this.mo90.toolsnos!=null)
            {
            }
            if (this.mo90.consumablenos!=null)
            {
            }
         if (this.mo90.gsenos==null)
         {
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo90(this.mo90).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/structure/mo90']);
         this.toastr.showInfo('Mo90 service updation success', 'Mo90 update');
       },
       error=>  this.toastr.showError(error,'Mo90 update')
