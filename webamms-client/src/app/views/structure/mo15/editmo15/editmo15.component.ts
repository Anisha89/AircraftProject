...
import { Mo15,Gse,Tools,Spare,Consumable } from '../../mo15/mo15.model';
...
@Component({
  ...
  templateUrl: './editmo15.component.html',
  styleUrls: ['./editmo15.component.css']
})
export class Editmo15Component implements OnInit {
  ...
  consumable=new Consumable();
    constructor(private _router:Router,private cservice:ConsumableserviceService,
      ...
      private _service :Mo15Service,private _gseservice:GseserviceService,
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo15(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo15=data;
          console.log("The gse s are="+this.mo15.gsenos);
     console.log(this.mo15);
       //   console.log("The spares  are="+this.mo15.sparenos);
           this.nam2=this.mo15.gsenos;
            this.name=this.mo15.gsenos;

             this.nam3=this.mo15.sparenos;
            this.namesp=this.mo15.sparenos;

            this.nam4=this.mo15.toolsnos;
            this.nametl=this.mo15.toolsnos;

            this.nam5=this.mo15.consumablenos;
            this.namecl=this.mo15.consumablenos;
    ...
    this._service. addUsertoRemotemo15(this.mo15).subscribe(
       data=>
      {
        console.log("data edited successfully");
         ...
         this.toastr.showInfo('Mo15 service updation success', 'Mo15 update');
       },
       error=>  this.toastr.showError(error,'Mo15 update')
