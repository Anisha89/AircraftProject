...
@Component({
  selector: "app-mo15",
  templateUrl: "./mo15.component.html",
  providers: [
    { provide: CarouselConfig, useValue: { interval: 1500, noPause: false } },
  ],

  encapsulation: ViewEncapsulation.None,
  styleUrls: ["./mo15.component.css"],
})

export class Mo15Component implements OnInit, OnDestroy {
  acitvities = [];
  start: any = 1;
  datagse: any;
  dataspare: any;
  ...
  ngOnInit(): void {
    ...
    this._service.countrecordmo15().subscribe((mydata) => {
      console.log(mydata);
      this.rec1 = mydata;
    ...
    this._service.getdatamo15(0, this.perpage).subscribe(
      (data) => {
        console.log(data);
        this.data = data;
        this.mo15 = data;
        this.totalItems = this.rec1;
        let activities = this.mo15;
      } /*for first mo15*/
    ); /* for first getdata*/
  ...
  handlePageChange(event: any) {
    ...
    if (this.mode == "searching") {
      this._service.counteruserecordmo15(this.searchname).subscribe((recs) => {
        console.log(recs);
      ...
      this._service
        ...
        .subscribe((datasear) => {
          ...
          this.rec1 = this.searchpages;
          this.mo15 = datasear;
          console.log("to test spare" + this.mo15);
        });
    } /*IF */ else if (this.mode == "normal" || this.mode == "deleting") {
      this._service.getdatamo15(this.x - 1, this.perpage).subscribe(
        (data) => {
          console.log(data);
          this.data = data;
  ...
  gotosearchservice(name: any) {
    ...
    if (this.perpageflag == "true") {
      ...
      this._service.fetchUserBymo15(this.m2, this.perpage, name).subscribe(
        (datasear) => {
          console.log(datasear);
          this.datapage = datasear;
          this.data = datasear;
  ...
  gotodeleteuser(id: number) {
    ...
    this._service.deleteUserByIdFromRemotemo15(id).subscribe(
      (data) => {
        ...
        if (this.perpageflag == "true") {
          this._service
            .getdatamo15(this.x - 1, parseInt(this.perpage))
            .subscribe((data) => {
              console.log(data);
              this.data = data;
          ...
          this._service.getdatamo15(this.x, 3).subscribe((data) => {
            console.log(data);
            this.data = data;
            //  this.totalItems=String(100);
          });
        } /* perpage false */
        this.toastr.showWarning("Deletion success", 'Mo15 service');
      },
      (error) => {
        this.msg1 = error;
