...
import { Mo60,Gse,Tools,Spare,Consumable } from '../mo60.model';
...
@Component({
  ...
  templateUrl: './addmo60.component.html',
  styleUrls: ['./addmo60.component.css']
})

export class Addmo60Component implements OnInit {
  mo60 =new Mo60();
...
console.log(this.mo60.gsenos);
  this._service.addUsertoRemotemo60(this.mo60).subscribe(
   ...
   {
     console.log(this.mo60.gsenos);
     this.toastr.showSuccess('Mo60 service added successfully', "Mo60 service");
