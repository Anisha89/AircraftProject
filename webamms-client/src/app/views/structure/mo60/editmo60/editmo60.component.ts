...
import { Mo60,Gse,Tools,Consumable,Spare } from '../../mo60/mo60.model';
import { Mo60Service } from '../../mo60/mo60.service';
...
@Component({
  ...
  templateUrl: './editmo60.component.html',
  styleUrls: ['./editmo60.component.css']
})
export class Editmo60Component implements OnInit {
  ...
  consumable=new Consumable
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo60(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo60=data;
          console.log("The gse s are="+this.mo60.gsenos);
     console.log(this.mo60);
       //   console.log("The spares  are="+this.mo60.sparenos);
           this.nam2=this.mo60.gsenos;
            this.name=this.mo60.gsenos;

             this.nam3=this.mo60.sparenos;
            this.namesp=this.mo60.sparenos;

            this.nam4=this.mo60.toolnos;
            this.nametl=this.mo60.toolnos;
            console.log(this.nam4 , "");

            this.nam5=this.mo60.consumablenos;
            this.namecl=this.mo60.consumablenos;
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo60(this.mo60).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/structure/mo60']);
         this.toastr.showInfo('Mo60 service updation success', 'Mo60 update');

       },
       error=>  this.toastr.showError(error,'Mo60 update')
