...
import { Mo12,Gse,Spare,Tools,Consumable} from '../../mo12/mo12.model';
import { Mo12Service } from '../../mo12/mo12.service';
import { NotificationService } from '../../../../service/toastrnotification.service';
@Component({
  selector: 'app-editmo12',
  templateUrl: './editmo12.component.html',
  styleUrls: ['./editmo12.component.css']
})
export class Editmo12Component implements OnInit {
  seldata:any;
  seldataspare:any;
  seldatatools:any;
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo12Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo12(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo12=data;
          console.log("The gse s are="+this.mo12.gsenos);
     console.log(this.mo12);
       //   console.log("The spares  are="+this.mo12.sparenos);
           this.nam2=this.mo12.gsenos;
            this.name=this.mo12.gsenos;

             this.nam3=this.mo12.sparenos;
            this.namesp=this.mo12.sparenos;

            this.nam4=this.mo12.toolsnos;
            this.nametl=this.mo12.toolsnos;

            this.nam5=this.mo12.consumablenos;
            this.namecl=this.mo12.consumablenos;
            ...
            if (this.mo12.gsenos != null)
            {
          
            }
            if (this.mo12.sparenos!=null)
            {
            }
            if (this.mo12.toolsnos!=null)
            {
            }
            if (this.mo12.consumablenos!=null)
            {
            }
         if (this.mo12.gsenos==null)
         {
    ...
    this._service. addUsertoRemotemo12(this.mo12).subscribe(
       data=>
      {
        console.log("data edited successfully");
         ...
         this.toastr.showInfo(' Mo12 service updation success', 'Mo12 update');

       },
       error=>  this.toastr.showError(error,'Mo12 update')      
