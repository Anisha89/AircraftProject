...
@Component({
  selector: 'app-mo12',
  templateUrl: './mo12.component.html',
  providers: [
    { provide: CarouselConfig, useValue: { interval: 1500, noPause: false } },
  ],
 
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./mo12.component.css']
})

export class Mo12Component implements OnInit,OnDestroy {
  acitvities=[];
  start:any=1;
  datagse:any;
  dataspare:any;
...
counter:any;
 ...
 datapage:any;
  ...
  constructor(private _http:HttpClient,
    ...
    private toolsservice:ToolsserviceService,private _service:Mo12Service,
  ...
  ngOnInit(): void {
    ...
    itemsPerPage: this.perpage,
     ...
     this._service.countrecordmo12().subscribe(
      mydata=>{console.log(mydata);
       ...
       this.m1=this.rec1;
        ...
        console.log("The perpage is "+this.perpage);
         ...
         this._service.getdatamo12(0,this.perpage).subscribe(
          (data)=>{console.log(data);
            this.data=data;
            this.mo12=data;
          this.totalItems=this.rec1;
          let activities=this.mo12;
           }/*for first mo12*/
      )/* for first getdata*/
...
handlePageChange(event:any) {
  this.x= event.page;
   ...
   if (this.mode=='searching')
   {
     ...
     this._service.counteruserecordmo12(this.searchname).subscribe(
   ...
   this._service.fetchUserBymo12(this.x-1,parseInt(this.perpage),this.searchname).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
     this.mo12=datasear;
     console.log("to test spare"+this.mo12);
     });
   ...
   {
   this._service.getdatamo12(this.x-1,this.perpage).subscribe(
     (data)=>{console.log(data);
       this.data=data;
 ...
 /*--------------------------------*/
   ...
   {
  this._service.fetchUserBymo12(this.m2,parseInt(this.perpage),name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
 ...
 {
   this._service.fetchUserBymo12(this.m2,this.perpage,name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
       this.rec1=this.searchpages;
...
gotodeleteuser(id: number)
  {
    this.mode="deleting";
     ...
     this._service.deleteUserByIdFromRemotemo12(id).subscribe (
       data => {
       ...
       // alert(this.x+this.perpageflag);
        if (this.perpageflag=="true")
        {
          this._service.getdatamo12(this.x-1,parseInt(this.perpage)).subscribe(
            (data)=>{console.log(data);
              this.data=data;
        ...
        {
          this._service.getdatamo12(this.x,3).subscribe(
            (data)=>{console.log(data);
              this.data=data;
            //  this.totalItems=String(100);
            })
        ...
        this.toastr.showWarning("Deletion success", 'Mo12 service');
      },
      error=>{
        this.msg1=error;
