...
import { Mo6,Gse,Tools,Spare,Consumable } from '../mo6.model';
...
@Component({
  ...
  templateUrl: './editmo6.component.html',
  styleUrls: ['./editmo6.component.css']
})
export class Editmo6Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo6Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo6(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo6=data;
          console.log("The gse s are="+this.mo6.gsenos);
     console.log(this.mo6);
       //   console.log("The spares  are="+this.mo6.sparenos);
           this.nam2=this.mo6.gsenos;
            this.name=this.mo6.gsenos;

             this.nam3=this.mo6.sparenos;
            this.namesp=this.mo6.sparenos;

            this.nam4=this.mo6.toolsnos;
            this.nametl=this.mo6.toolsnos;

            this.nam5=this.mo6.consumablenos;
            this.namecl=this.mo6.consumablenos;
            ...
            if (this.mo6.gsenos != null)
            {
          
            }
            if (this.mo6.sparenos!=null)
            {
            }
            if (this.mo6.toolsnos!=null)
            {
            }
            if (this.mo6.consumablenos!=null)
            {
            }
         if (this.mo6.gsenos==null)
         {
 ...
 this.cservice.fetchUserListFromRemoteconsumable().subscribe(data=>{
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo6(this.mo6).subscribe(
       data=>
      {
        console.log("data edited successfully");
        this.toastr.showInfo(' service updation success', 'Mo6 update');
         this._router .navigate(['/system/mo6']);
   
       },
       error=>  this.toastr.showError(error,' Mo6 update')
