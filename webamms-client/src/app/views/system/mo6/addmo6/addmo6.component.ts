...
import { Mo6,Gse,Spare,Tools,Consumable } from '../mo6.model';
...
@Component({
  selector: 'app-addmo6',
  templateUrl: './addmo6.component.html',
  styleUrls: ['./addmo6.component.css']
})

export class Addmo6Component implements OnInit {
  mo6 =new Mo6();
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo6Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient,private toastr:NotificationService) { }
...
console.log(this.mo6.gsenos);
  this._service.addUsertoRemotemo6(this.mo6).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess('Mo6 service added successfully', "Mo6 service");
