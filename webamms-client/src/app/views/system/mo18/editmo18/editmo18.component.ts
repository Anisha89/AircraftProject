...
import { Mo18,Gse,Tools,Consumable,Spare} from '../mo18.model';
...
@Component({
  ...
  templateUrl: './editmo18.component.html',
  styleUrls: ['./editmo18.component.css']
})
export class Editmo18Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo18Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo18(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo18=data;
          console.log("The gse s are="+this.mo18.gsenos);
     console.log(this.mo18);
       //   console.log("The spares  are="+this.mo18.sparenos);
           this.nam2=this.mo18.gsenos;
            this.name=this.mo18.gsenos;

             this.nam3=this.mo18.sparenos;
            this.namesp=this.mo18.sparenos;

            this.nam4=this.mo18.toolsnos;
            this.nametl=this.mo18.toolsnos;

            this.nam5=this.mo18.consumablenos;
            this.namecl=this.mo18.consumablenos;
            ...
            if (this.mo18.gsenos != null)
            {
          
            }
            if (this.mo18.sparenos!=null)
            {
            }
            if (this.mo18.toolsnos!=null)
            {
            }
            if (this.mo18.consumablenos!=null)
            {
            }
         if (this.mo18.gsenos==null)
         {
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo18(this.mo18).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/system/mo18']);
         this.toastr.showInfo('Mo18 service updation success', 'Mo18 update');

       },
       error=>  this.toastr.showError(error,'Mo18 update')      
