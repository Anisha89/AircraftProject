...
@Component({
  ...
  templateUrl: './addmo18.component.html',
  styleUrls: ['./addmo18.component.css']
})

export class Addmo18Component implements OnInit {
  mo18 =new Mo18();
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo18Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient,private toastr:NotificationService) { }
...
console.log(this.mo18.gsenos);
  this._service.addUsertoRemotemo18(this.mo18).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess('Mo18 service added successfully', "Mo18 service");
