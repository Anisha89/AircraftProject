...
import { Mo48,Gse,Tools,Consumable,Spare } from '../mo48.model';
import { Mo48Service } from '../mo48.service';

@Component({
  selector: 'app-addmo48',
  templateUrl: './addmo48.component.html',
  styleUrls: ['./addmo48.component.css']
})
export class Addmo48Component implements OnInit {
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo48Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient,private toastr:NotificationService) { }
...
adduserformsubmit(){
 ...
 this.mo48.consumablenos='00';
  ...
  this._service.addUsertoRemotemo48(this.mo48).subscribe(
    data=>
   {
     console.log(this.mo48.gsenos);
     console.log("data added successfully");
     this.toastr.showSuccess('Mo48 service added successfully', "Mo48 service");
