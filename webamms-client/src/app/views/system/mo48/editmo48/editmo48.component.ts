...
import { Mo48,Gse,Tools,Spare,Consumable } from '../../mo48/mo48.model';
import { Mo48Service } from '../../mo48/mo48.service';
import { NotificationService } from '../../../../service/toastrnotification.service';
@Component({
  selector: 'app-editmo48',
  templateUrl: './editmo48.component.html',
  styleUrls: ['./editmo48.component.css']
})
export class Editmo48Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo48Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo48(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo48=data;
          console.log("The gse s are="+this.mo48.gsenos);
     console.log(this.mo48);
       //   console.log("The spares  are="+this.mo48.sparenos);
           this.nam2=this.mo48.gsenos;
            this.name=this.mo48.gsenos;

             this.nam3=this.mo48.sparenos;
            this.namesp=this.mo48.sparenos;

            this.nam4=this.mo48.toolsnos;
            this.nametl=this.mo48.toolsnos;

            this.nam5=this.mo48.consumablenos;
            this.namecl=this.mo48.consumablenos;
            ...
            if (this.mo48.gsenos != null)
            {
          
            }
            if (this.mo48.sparenos!=null)
            {
            }
            if (this.mo48.toolsnos!=null)
            {
            }
            if (this.mo48.consumablenos!=null)
            {
            }
         if (this.mo48.gsenos==null)
         {
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo48(this.mo48).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/system/mo48']);
         this.toastr.showInfo('Mo48 service updation success', 'Mo48 update');
       },
       error=>  this.toastr.showError(error,'Mo48 update')
