...
import { Mo36,Gse,Tools,Spare,Consumable } from '../../mo36/mo36.model';
import { Mo36Service } from '../../mo36/mo36.service';
import { NotificationService } from '../../../../service/toastrnotification.service';
@Component({
  selector: 'app-editmo36',
  templateUrl: './editmo36.component.html',
  styleUrls: ['./editmo36.component.css']
})
export class Editmo36Component implements OnInit {
...
seldata:any;
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo36Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo36(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo36=data;
          console.log("The gse s are="+this.mo36.gsenos);
     console.log(this.mo36);
       //   console.log("The spares  are="+this.mo36.sparenos);
           this.nam2=this.mo36.gsenos;
            this.name=this.mo36.gsenos;

             this.nam3=this.mo36.sparenos;
            this.namesp=this.mo36.sparenos;

            this.nam4=this.mo36.toolsnos;
            this.nametl=this.mo36.toolsnos;

            this.nam5=this.mo36.consumablenos;
            this.namecl=this.mo36.consumablenos;
            ...
            if (this.mo36.gsenos != null)
            {
          
            }
            if (this.mo36.sparenos!=null)
            {
            }
            if (this.mo36.toolsnos!=null)
            {
            }
            if (this.mo36.consumablenos!=null)
            {
            }
         if (this.mo36.gsenos==null)
         {
    ...
    this._service. addUsertoRemotemo36(this.mo36).subscribe(
       data=>
      {
        console.log("data edited successfully");
         ...
         this.toastr.showInfo('Mo36 service updation success', 'Mo36 update');

       },
       error=>  this.toastr.showError(error,'Mo36 update')
