...
import { Mo72,Gse,Tools,Spare,Consumable } from '../mo72.model';
import { Mo72Service } from '../mo72.service';

@Component({
  selector: 'app-addmo72',
  templateUrl: './addmo72.component.html',
  styleUrls: ['./addmo72.component.css']
})
export class Addmo72Component implements OnInit {
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo72Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient, private toastr:NotificationService) { }
...
adduserformsubmit(){
 ...
 this.mo72.consumablenos='00';
  ...
  this._service.addUsertoRemotemo72(this.mo72).subscribe(
    data=>
   {
     console.log(this.mo72.gsenos);
     console.log("data added successfully");
     this.toastr.showSuccess('Mo72 service added successfully', "Mo72 service");
