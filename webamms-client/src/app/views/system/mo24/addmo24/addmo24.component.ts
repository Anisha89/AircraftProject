...
import { Mo24,Gse,Tools,Consumable,Spare } from '../mo24.model';
import { Mo24Service } from '../mo24.service';

@Component({
  selector: 'app-addmo24',
  templateUrl: './addmo24.component.html',
  styleUrls: ['./addmo24.component.css']
})
export class Addmo24Component implements OnInit {
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo24Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient,private toastr:NotificationService) { }
...
adduserformsubmit(){
 ...
 this.mo24.consumablenos='00';
  ...
  this._service.addUsertoRemotemo24(this.mo24).subscribe(
    data=>
   {
     console.log(this.mo24.gsenos);
     console.log("data added successfully");
     this.toastr.showSuccess('Mo24 service added successfully', "Mo24 service");
