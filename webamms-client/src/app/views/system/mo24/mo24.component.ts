...
import { Mo24Service } from './mo24.service';
...
@Component({
  selector: 'app-mo24',
  templateUrl: './mo24.component.html',
  providers: [
    { provide: CarouselConfig, useValue: { interval: 1500, noPause: false } },
  ],
 
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./mo24.component.css']
})

export class Mo24Component implements OnInit,OnDestroy {
  acitvities=[];
  start:any=1;
  datagse:any;
  dataspare:any;
 ...
 counter:any;
  ...
  ngOnInit(): void {
    ...
    itemsPerPage: this.perpage,
     ...
     this._service.countrecordmo24().subscribe(
      mydata=>{console.log(mydata);
       ...
       this.m1=this.rec1;
        ...
        console.log("The perpage is "+this.perpage);
         ...
         this._service.getdatamo24(0,this.perpage).subscribe(
          (data)=>{console.log(data);
            this.data=data;
            this.mo24=data;
          this.totalItems=this.rec1;
          let activities=this.mo24;
           }/*for first mo24*/
      )/* for first getdata*/
...
handlePageChange(event:any) {
  this.x= event.page;
   ...
   if (this.mode=='searching')
   {
     ...
     this._service.counteruserecordmo24(this.searchname).subscribe(
   ...
   this._service.fetchUserBymo24(this.x-1,parseInt(this.perpage),this.searchname).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
     this.mo24=datasear;
     console.log("to test spare"+this.mo24);
     });
   ...
   {
   this._service.getdatamo24(this.x-1,this.perpage).subscribe(
     (data)=>{console.log(data);
       this.data=data;
 ...
 /*--------------------------------*/
   ...
   {
  this._service.fetchUserBymo24(this.m2,parseInt(this.perpage),name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
 ...
 {
   this._service.fetchUserBymo24(this.m2,this.perpage,name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
       this.rec1=this.searchpages;
...
gotodeleteuser(id: number)
  {
    this.mode="deleting";
     ...
     this._service.deleteUserByIdFromRemotemo24(id).subscribe (
       data => {
       ...
       // alert(this.x+this.perpageflag);
        if (this.perpageflag=="true")
        {
          this._service.getdatamo24(this.x-1,parseInt(this.perpage)).subscribe(
            (data)=>{console.log(data);
              this.data=data;
        ...
        {
          this._service.getdatamo24(this.x,6).subscribe(
            (data)=>{console.log(data);
              this.data=data;
            //  this.totalItems=String(100);
            })
        ...
        this.toastr.showWarning("Deletion success", 'Mo24 service');
      },
      error=>{
        this.msg1=error;
         console.log(this.msg1);
         this.toastr.showError(error,'Mo24 service')
      }
    ) 
