...
import { Mo24 ,Gse,Spare,Tools,Consumable} from '../../mo24/mo24.model';
import { Mo24Service } from '../../mo24/mo24.service';
import { NotificationService } from '../../../../service/toastrnotification.service';
@Component({
  selector: 'app-editmo24',
  templateUrl: './editmo24.component.html',
  styleUrls: ['./editmo24.component.css']
})
export class Editmo24Component implements OnInit {
  ...
  consumable=new Consumable
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo24Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo24(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo24=data;
          console.log("The gse s are="+this.mo24.gsenos);
     console.log(this.mo24);
       //   console.log("The spares  are="+this.mo24.sparenos);
           this.nam2=this.mo24.gsenos;
            this.name=this.mo24.gsenos;

             this.nam3=this.mo24.sparenos;
            this.namesp=this.mo24.sparenos;

            this.nam4=this.mo24.toolsnos;
            this.nametl=this.mo24.toolsnos;

            this.nam5=this.mo24.consumablenos;
            this.namecl=this.mo24.consumablenos;
            ...
            if (this.mo24.gsenos != null)
            {
          
            }
            if (this.mo24.sparenos!=null)
            {
            }
            if (this.mo24.toolsnos!=null)
            {
            }
            if (this.mo24.consumablenos!=null)
            {
            }
         if (this.mo24.gsenos==null)
         {
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo24(this.mo24).subscribe(
       data=>
      {
        console.log("data edited successfully");
         this._router .navigate(['/system/mo24']);
         this.toastr.showInfo('Mo24 service updation success', 'Mo24 update');
       },
       error=> error=>  this.toastr.showError(error,'Mo24 update')
