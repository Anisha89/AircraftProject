...
import { Mo1,Gse,Spare,Tools,Consumable } from '../mo1.model';
...
@Component({
  selector: 'app-addmo1',
  templateUrl: './addmo1.component.html',
  styleUrls: ['./addmo1.component.css']
})

export class Addmo1Component implements OnInit {
  mo1 =new Mo1();
...
copystrcl:any;
  ...
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo1Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient,    private toastr:NotificationService) { }
...
console.log(this.mo1.gsenos);
  this._service.addUsertoRemotemo1(this.mo1).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess(' Mo1 service added successfully', "Mo1 service")
