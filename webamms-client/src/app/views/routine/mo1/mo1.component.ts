...
@Component({
  selector: 'app-mo1',
  templateUrl: './mo1.component.html',
  providers: [
    { provide: CarouselConfig, useValue: { interval: 1500, noPause: false } },
  ],
 
  encapsulation: ViewEncapsulation.None,
  styleUrls: ['./mo1.component.css']
})

export class Mo1Component implements OnInit,OnDestroy {
  acitvities=[];
  start:any=1;
  datagse:any;
  dataspare:any;
 ...
 datapage:any;
  ...
  ngOnInit(): void {
    ...
    itemsPerPage: this.perpage,
     ...
     this._service.countrecordmo1().subscribe(
      mydata=>{console.log(mydata);
       ...
       this.m1=this.rec1;
        ...
        console.log("The perpage is "+this.perpage);
         ...
         this._service.getdatamo1(0,this.perpage).subscribe(
          (data)=>{console.log(data);
            this.data=data;
            this.mo1=data;
          this.totalItems=this.rec1;
          let activities=this.mo1;
           }/*for first mo1*/
      )/* for first getdata*/
...
handlePageChange(event:any) {
  this.x= event.page;
   ...
   if (this.mode=='searching')
   {
     ...
     this._service.counteruserecordmo1(this.searchname).subscribe(
   ...
   this._service.fetchUserBymo1(this.x-1,parseInt(this.perpage),this.searchname).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
     this.mo1=datasear;
     console.log("to test spare"+this.mo1);
     });
   ...
   {
   this._service.getdatamo1(this.x-1,this.perpage).subscribe(
     (data)=>{console.log(data);
       this.data=data;
 ...
 /*--------------------------------*/
   ...
   {
  this._service.fetchUserBymo1(this.m2,parseInt(this.perpage),name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
     this.rec1=this.searchpages;
 ...
 {
   this._service.fetchUserBymo1(this.m2,this.perpage,name).subscribe(
     (datasear)=>{console.log(datasear);
       this.datapage=datasear;
       this.data=datasear;
       this.rec1=this.searchpages;
...
gotodeleteuser(id: number)
  {
    this.mode="deleting";
     ...
     this._service.deleteUserByIdFromRemotemo1(id).subscribe (
       data => {
       ...
       // alert(this.x+this.perpageflag);
        if (this.perpageflag=="true")
        {
          this._service.getdatamo1(this.x-1,parseInt(this.perpage)).subscribe(
            (data)=>{console.log(data);
              this.data=data;
        ...
        {
          this._service.getdatamo1(this.x,3).subscribe(
            (data)=>{console.log(data);
              this.data=data;
            //  this.totalItems=String(100);
            })
        ...
        this.toastr.showWarning("Deletion success", 'Mo1 service');
      },
      error=>{
        this.msg1=error;
         console.log(this.msg1);
         this.toastr.showError(error,'Mo1 service')
      }
    ) 
