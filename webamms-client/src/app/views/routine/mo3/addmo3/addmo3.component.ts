...
import { Mo3,Spare,Tools,Consumable,Gse } from '../mo3.model';
...
@Component({
  selector: 'app-addmo3',
  templateUrl: './addmo3.component.html',
  styleUrls: ['./addmo3.component.css']
})

export class Addmo3Component implements OnInit {
  mo3 =new Mo3();
...
;  
  constructor(private _router:Router,private consumableservice:ConsumableserviceService,private toolsservice:ToolsserviceService, private _service :Mo3Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private _http:HttpClient,private toastr:NotificationService) { }
...
console.log(this.mo3.gsenos);
  this._service.addUsertoRemotemo3(this.mo3).subscribe(
    data=>
   {
     ...
     this.toastr.showSuccess(' Mo3 service added successfully', " Mo3 service")
