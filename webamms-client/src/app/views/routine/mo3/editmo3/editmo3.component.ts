...
import { Mo3Service} from '../../mo3/mo3.service';
import { Mo3,Gse,Spare,Tools,Consumable } from '../../mo3/mo3.model';
import { NotificationService } from '../../../../service/toastrnotification.service';


@Component({
  selector: 'app-editmo3',
  templateUrl: './editmo3.component.html',
  styleUrls: ['./editmo3.component.css']
})
export class Editmo3Component implements OnInit {
  ...
  consumable=new Consumable();
    constructor(private _router:Router,private cservice:ConsumableserviceService,private tservice:ToolsserviceService, private _activatedroute:ActivatedRoute,private _service :Mo3Service,private _gseservice:GseserviceService,private _spareservice:SpareserviceService,private toastr:NotificationService
    ...
    ngOnInit(): void 
    {
      ...
      this._service.fetchUserByIdFromRemotemo3(id).subscribe(
        data=>{
          console.log("data recevied");
          this.mo3=data;
          console.log("The gse s are="+this.mo3.gsenos);
     console.log(this.mo3);
       //   console.log("The spares  are="+this.mo3.sparenos);
           this.nam2=this.mo3.gsenos;
            this.name=this.mo3.gsenos;

             this.nam3=this.mo3.sparenos;
            this.namesp=this.mo3.sparenos;

            this.nam4=this.mo3.toolsnos;
            this.nametl=this.mo3.toolsnos;

            this.nam5=this.mo3.consumablenos;
            this.namecl=this.mo3.consumablenos;
  ...
  updateeditformsubmit(){
    ...
    this._service. addUsertoRemotemo3(this.mo3).subscribe(
       data=>
      {
        console.log("data edited successfully");
        this.toastr.showInfo('Mo3 service updation success', 'Mo3 update')

         this._router .navigate(['/routine/mo3']);
   
       },
       error=>  this.toastr.showError(error,'Mo3 update')
